...
const onSwitchChange = async (values) => {
  console.log(values);
};

const onModeChange = async (values) => {
  console.log(values);
};

const onTempChange = async (value) => {
  console.log(value);
};

const onFeeChange = async (value) => {
  console.log(value);
};

const onSlaveChange = async (value) => {
  console.log(value);
};
